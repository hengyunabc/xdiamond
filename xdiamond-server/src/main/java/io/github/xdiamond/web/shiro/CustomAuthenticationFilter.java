...
public class CustomAuthenticationFilter extends AuthorizationFilter {
  ...
  public String getUnauthorizedJSONString() {
    return unauthorizedJSONString;
  }

  public void setUnauthorizedJSONString(String unauthorizedJSONString) {
    this.unauthorizedJSONString = unauthorizedJSONString;
  }

  public String getForbiddenJSONString() {
    return forbiddenJSONString;
  }

  public void setForbiddenJSONString(String forbiddenJSONString) {
    this.forbiddenJSONString = forbiddenJSONString;
  }
}
